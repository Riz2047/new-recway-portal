...
<img width="100%" alt="Recway" src="https://github.com/user-attachments/assets/c56009a4-718f-43dc-bd1e-caad5417b05b"  />
...
-   **Feat:** Refactor Recway whole Admin UI - Icons, Accessibility, Components, Pages, Layouts and so on.
...
-   **Feat:** Rest API For Recway, Scramble API documentation.
...
So, You've got the project of Recway on your local machine - http://localhost:8000
...
We've used [Scramble](https://github.com/dedoc/scramble) to automatically generate the Rest API documentation for Recway. You can find the API documentation at:
...
Laravel Boost is already installed in this project to provide enhanced development and debugging tools for Recway.
