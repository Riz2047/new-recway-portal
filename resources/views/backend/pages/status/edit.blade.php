<x-layouts.backend-layout :breadcrumbs="$breadcrumbs">
    <form
        action="{{ route('admin.status.update', [$serviceCategory->id, $status->id]) }}"
        method="POST"
    ...
    >
        ...
        <x-card>
            <x-slot name="header">
                {{ __('Edit Status') }} - {{ $serviceCategory->name }}
            </x-slot>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input 
                            ...
                            name="status_sv" 
                            id="status_sv" 
                            value="{{ old('status_sv', $status->status_sv) }}"
                            class="form-control"
                    ...
                    <div class="space-y-1">
                        ...
                        <input 
                            ...
                            id="variable" 
                            required 
                            value="{{ old('variable', $status->variable) }}"
                            class="form-control"
                    ...
                    <div class="space-y-1">
                        ...
                        <input 
                            ...
                            name="status_detail" 
                            id="status_detail" 
                            value="{{ old('status_detail', $status->status_detail) }}"
                            class="form-control"
                    ...
                    <div class="space-y-1">
                        ...
                        <input 
                            ...
                            name="color" 
                            id="color" 
                            value="{{ old('color', $status->color ?? '#3b82f6') }}"
                    ...
                    <div class="space-y-1 relative">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                name="status_icon" 
                                id="status_icon" 
                                value="{{ old('status_icon', $status->status_icon) }}"
