            ...
            <div class="px-5 py-4 sm:px-6 sm:py-5">
                ...
                <div class="mb-6 flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <div class="flex items-center">
                        ...
                        {{ __('Status:') }}
                        <span class="ml-1 {{ get_post_status_class($post->status) }}">{{ $post->status ? ucfirst($post->status) : '-' }}</span>
                    </div>
                </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            ...
                            @foreach($groupedTerms as $taxonomy => $terms)
                                <div>
                                    <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ $taxonomy ? ucfirst($taxonomy) : '' }}</h5>
