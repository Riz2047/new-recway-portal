...
@section('title', __('Add Reviewer') . ' | ' . config('app.name'))
@section('page-title', __('Add Reviewer'))
...
<nav class="mb-4 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
    ...
    <span class="font-medium text-gray-800 dark:text-white">{{ __('Add Reviewer') }}</span>
</nav>

<div class="mx-auto max-w-md">
<div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
    <h2 class="mb-5 text-sm font-semibold text-gray-700 dark:text-gray-200">{{ __('New Reviewer') }}</h2>
    ...
    <form action="{{ route('customer.reviewers.store') }}" method="POST" class="space-y-4">
        @csrf
        <div>
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                <input :type="show ? 'text' : 'password'" name="password"
                    ...
                    placeholder="{{ __('Min. 6 characters') }}" required>
