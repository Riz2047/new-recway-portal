...
class SettingsSeeder extends Seeder
{
    ...
    {
        $options = [
            ['option_name' => 'app_name', 'option_value' => 'Recway'],

            // theme colors.
            ['option_name' => 'theme_primary_color', 'option_value' => '#e60f3a'],
            ...
            // Site logo and icons.
            ['option_name' => 'site_logo_lite', 'option_value' => '/images/logo/recway.png'],
            ['option_name' => 'site_logo_dark', 'option_value' => '/images/logo/logo-dark.png'],
            ['option_name' => 'site_icon', 'option_value' => '/images/logo/favicon.png'],
            ['option_name' => 'site_favicon', 'option_value' => '/images/logo/favicon.png'],
