...
class RoleController extends Controller
{
    ...
    public function update(UpdateRoleRequest $request, int $id): RedirectResponse
    {
        ...
        // Check if this is the Admin role in demo mode - return 403 directly
        if (config('app.demo_mode') && $role->name === 'Admin') {
            abort(403, 'Cannot modify Admin role in demo mode.');
        }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        // Check if this is the Admin role in demo mode - return 403 directly
        if (config('app.demo_mode') && $role->name === Role::ADMIN) {
            abort(403, 'Cannot delete Admin role in demo mode.');
        }
