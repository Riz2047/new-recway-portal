...
?>
        <div class="box shadow">
            ...
            <form id="status-form" action="update-status.php?id=<?php echo $_GET['id'] ?>" method="post" enctype="multipart/form-data">
                <div class="row p-0 m-0">
                    <div class="row p-0 m-0 upload-report">
...
?>
                        ...
                        <div class="col-lg-6 ps-0">
                            ...
                            <input type="date" id="date" required name="date" class="sign-input w-100 mb-3">
                        </div>
                        <div class="col-lg-12 ps-0">
                            <p class="f-14 mb-0 pb-0 w-500">Comment</p>
                            <textarea name="comment" id="" rows="3" class="w-100 mb-3 sign-textarea"></textarea>
                        </div>
                        <div class="col-lg-12 ps-0">
                            <p class="f-14 mb-0 pb-0 w-500">Upload Report</p>
                            <input name="report" type="file" class="form-control w-100 mb-3">
                        </div>
