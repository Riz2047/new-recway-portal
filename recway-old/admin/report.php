                ...
                <form action="process.php" method="post">
                    <div class="row p-0 m-0">
                        ...
                        <?php else: ?>
                                <div class="elements">
                                    <div class="mb-2">
                                        <a href="report-sv.php?id=<?php echo $_GET['id'] ?>">Translate to Swedish</a>
                                    </div>
                                    ...
                                    <div class="introduction text grab-elements">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" name="intro_heading" value="Introduction" required class="sign-input w-100 mb-3" placeholder="Introduction heading ">
                                        </div>
                                        <div class="col-lg-12">
                                    ...
                                    <div data-table-id="tableIncome" style="overflow-x: auto" class="tableIncome grab-elements">
                                        ...
                                        <table id="tableIncome" class="w-100" style="min-width: 722px">
                                            ...
                                            <tr>
                                                ...
                                                <td>
<!--                                                    <input type="text" value="Approval" class="sign-input">-->
