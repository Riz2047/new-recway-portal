...
if(isset($_POST['add'])) {
    ...
    if(!empty($res)) {
        $message = "<p class='alert alert-success'>Place added successfully!</p>";
    } else {
        $message = "<p class='alert alert-danger'>Could not add place!</p>";
    }
}
                            ...
                            <form action="" method="post">
                                <div class="row p-0 m-0">
                                    <div class="col-lg-12 ps-0">
                                        ...
                                        <input type="text" required name="name" class="sign-input w-100 mb-3" placeholder="Place Name ">
                                    </div>
                                    <div class="col-lg-12 ps-0">
