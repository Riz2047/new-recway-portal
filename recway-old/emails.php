                            ...
                            <div class="row">
                                <?php if (!empty($statuses)): ?>
                                    <?php foreach ($statuses as $status): ?>
                                        ...
                                        <div class="col-lg-3">
                                            <label><input <?php echo isEmailAllowed($_SESSION['customer']->id, $status[0]->id) ? 'checked' : '' ?> type="checkbox" class="emails-status" value="<?php echo $status[0]->id ?>" data-cus-id="<?php echo $_SESSION['customer']->id ?>"> <?php echo $status[0]->status ?></label>
                                        </div>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                <?php endif; ?>
