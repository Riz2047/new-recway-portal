...
if (isset($_GET['status'])) {
    $query = "SELECT * FROM candidates WHERE cus_id = ? AND dep_id = ? AND status = {$_GET['status']} AND expired = 0";
...
<section>
    <div class="container mt-3">
        <div class="row">
            <p class="f-14 text-grey w-400 mb-0 pb-0">List of Interview Orders</p>
            <div class="col-lg-12">
