...
$_GET['id'] = $_SESSION['department_user']->dep_user_id;

if (isset($_POST['update'])) {
  $name = $_POST['name'];
  $phone = $_POST['phone'];

  $query = 'UPDATE department_users SET name = ?, phone = ?';
  ...
  if (!empty($_POST['password'])) {
    ...
    $res = $stmt->execute([$name, $phone, $crypt_pass, $_GET['id']]);
   } else {
    $query .= " WHERE id = ?";

    $stmt = $conn->prepare($query);
    $res = $stmt->execute([$name, $phone, $_GET['id']]);
  }
      ...
      <div class="col-lg-12">
        <form action="" method="post" class="form">
          ...
          <div class="d-flex align-items-center form-row mb-3">
            ...
            <input id="name" type="text" required name="name" value="<?php echo $customer->dep_user_name ?>" placeholder="Enter Name" class="w-100 from-input">
          ...
          <div class="d-flex align-items-center form-row mb-3">
            ...
            <input id="email" type="email" required disabled name="email" value="<?php echo $customer->dep_user_email ?>" placeholder="Enter Email" class="w-100 from-input">
            <div class="form-icon me-2">
          ...
          <!-- <div class="d-flex align-items-center form-row mb-3">
            ...
            <input id="phone" type="text" required name="phone" value="<?php echo $customer->dep_user_phone ?>" placeholder="Enter Phone Number" class="w-100 from-input">
            <div class="form-icon me-2">
