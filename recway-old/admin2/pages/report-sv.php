        ...
        <div class="row ">
            <div class="table-section">
                ...
                <div class="col-md-12 mb-3">
                    <div class="row">
                        <div class="col-lg-4 ">
                            <button type="button" class="btn-primary-sm bg-primary w-100 mt-4 mx-0" onclick="bk_1()"><a>Background Check Level 1</a></button>
                        </div>
                        <div class="col-lg-4 ">
                            <button type="button" class="btn-primary-sm bg-primary w-100 mt-4 mx-0" onclick="bk_2()"><a>Background Check Level 2</a></button>
                        </div>
                    </div>
                </div>
                <form action="process.php" method="post" class="update-form">
                    <div class="row rowToHide">
                        <div id="report-html">
                                    ...
                                    <div class="elements">
                                        ...
                                        <div class="introduction text grab-elements">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="intro_heading" value="Introduktion" required class="sign-input form-control w-100 mb-3" placeholder="Introduction heading ">
                                            </div>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="background text grab-elements">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" value="Bakgrund" name="background_heading" required class="sign-input form-control w-100 mb-3" placeholder="Background heading ">
                                            </div>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="information text grab-elements">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" value="INFORMATION OCH FAKTA" name="information_heading" required class="sign-input form-control w-100 mb-3" placeholder="Background heading ">
                                            </div>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="comment text mb-3 grab-elements" style="">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="comment_headings[]" required="" class="sign-input form-control w-100 mb-3 comment_headings" placeholder="Text heading " value="SUMMERING">
                                            </div>
                                            <div class="col-lg-12">
                                                <p class="f-16 mb-0 pb-0 w-600">Text Description</p>
                                                <textarea name="comment_description[]" id="" required="" placeholder="Text description" rows="3" class="w-100 sign-textarea mb-3 comment_descriptions" spellcheck="true">Efter en omfattande och professionell bakgrundskontroll kan det fastställas att Niklas har en pålitlig och trovärdig bakgrund utan några avvikelser eller negativa indikationer. Personuppgifterna har verifierats och bekräftats som korrekta och övertygande.
Ekonomiskt sett har inga misstänkta eller olagliga finansiella transaktioner upptäckts i samband med Niklas namn, och hans ekonomiska bakgrund bedöms som stabil och utan indikationer på eventuell ohederlighet.
Inom den juridiska historiken har ingen straffrättslig eller civilrättslig anmärkning, brottsutredning eller pågående tvist identifierats som kan kopplas till Niklas.
Körkortskontrollen har visat att Niklas körkortsstatus är intakt, och det har inte påvisats några rapporter om återkallande, indragning eller ogiltighet av hans körkort.
Vid granskningen av eventuella registrerade fordon i Niklas namn har inga negativa uppgifter eller problem hittats i samband med registreringen eller ägandet.
När det gäller fastighetsinnehav har inga misstänkta eller oegentliga fastighetsaffärer upptäckts i samband med Niklas.
I fråga om bolagsengagemang har alla deltaganden i bolag av Niklas undersökts, och det finns inga tecken på att han är involverad i några oseriösa eller tvivelaktiga bolagsaffärer.
Granskningen av Niklas involvering som verklig huvudman i olika bolag har inte visat några indikationer på att han är kopplad till några skumma företagsstrukturer.
När det gäller internetexponering har alla relevanta delar av Niklas exponering undersökts, och inga negativa associationer eller rykten har identifierats.
Sociala medieaktiviteten har granskats noggrant, och inga avvikelser eller oegentligheter har noterats på Niklas sociala medieplattformar.
Vid studier av Niklas exponering i nyhetsmedier har inga negativa händelser eller publiceringar som skulle kunna skapa tvivel kring hans pålitlighet identifierats.
Sammanfattningsvis ger resultaten av bakgrundskontrollen ett klart och övertygande bevis för Niklas pålitlighet och lämplighet för olika syften som kan kräva en sådan kontroll. Han kan anses vara en pålitlig individ med en ren och trovärdig bakgrund.
                                                    </textarea>
                                                <select id="" class="form-select mb-3">
                                                    <option value="left">Left</option>
                                                    <option value="justify">Justify</option>
                                        ...
                                        <!--                                    <input type="text" name="facebook" required class="sign-input form-control w-100 mb-3" placeholder="Facebook profile link ">-->
                                        <!--                                </div>-->
                                        <!---->
                                        <!--                                <div class="col-lg-4">-->
                                        <!--                                    <p class="f-16 mb-0 pb-0 w-600">Instagram</p>-->
                                        <!--                                    <input type="text" name="instagram" required class="sign-input form-control w-100 mb-3" placeholder="Instagram profile link ">-->
                                        <!--                                </div>-->
                                        <!---->
                                        <!--                                <div class="col-lg-4">-->
                                        <!--                                    <p class="f-16 mb-0 pb-0 w-600">Twitter</p>-->
                                        <!--                                    <input type="text" name="twitter" required class="sign-input form-control w-100 mb-3" placeholder="Twitter profile link ">-->
                                        <!--                                </div>-->
                                        <!--                            </div>-->
                                        ...
                                        <div data-table-id="table-5" style="overflow-x: auto" class="tables grab-elements">
                                            <p class="mt-2" data-table-id="table-5">
                                                ...
                                                <strong contenteditable="true">Ekonomi</strong>
                                            </p>
                                            <table id="table-5" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Betalningsanmärkningar" class="sign-input form-control" name="table-5_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-5_col2[]">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Skulder hos kronofogdemyndigheten" class="sign-input form-control" name="table-5_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-5_col2[]">
                                                        </td>
                                        ...
                                        <div data-table-id="tableIncome" style="overflow-x: auto" class="tableIncome grab-elements">
                                            <p data-table-id="tableIncome" class="mt-2">
                                                <i style="cursor: grab" class="bi bi-grip-vertical"></i>
                                                <strong contenteditable="true">Inkomstuppgifter</strong>
                                            </p>
                                            <table id="tableIncome" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Typ av uppgift" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="2022 (inkomstår 2021)" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="2021 (inkomstår 2020)" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="2020 (inkomstår 2019)" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <!--                                            <input type="text" value="Godkännande" class="sign-input form-control">-->
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Taxerad inkomst" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Underskott av kapital" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control">
                                                        </td>
                                        ...
                                        <div data-table-id="table-0" style="overflow-x: auto" class="tables grab-elements">
                                            <p class="mt-2" data-table-id="table-0">
                                                <i style="cursor: grab" class="bi bi-grip-vertical"></i>
                                                <strong contenteditable="true">Juridik</strong>
                                            </p>
                                            <table id="table-0" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Dom tingsrätt" class="sign-input form-control" name="table-0_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-0_col2[]">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Dom hovrätt" class="sign-input form-control" name="table-0_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-0_col2[]">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Dom förvaltningsrätter" class="sign-input form-control" name="table-0_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-0_col2[]">
                                                        </td>
                                        ...
                                        <div data-table-id="table-1" style="overflow-x: auto" class="tables grab-elements">
                                            <p class="mt-2" data-table-id="table-1">
                                                <i style="cursor: grab" class="bi bi-grip-vertical"></i>
                                                <strong contenteditable="true">Bolagsengagemang</strong>
                                            </p>
                                            <table id="table-1" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Styrelseledamot & Ordförande" class="sign-input form-control" name="table-1_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-1_col2[]">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Historiska bolagsengagemang" class="sign-input form-control" name="table-1_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-1_col2[]">
                                                        </td>
                                        ...
                                        <div data-table-id="table-6" class="tables grab-elements" style="overflow-x: auto;">
                                            <p class="mt-2" data-table-id="table-6">
                                                ...
                                                <strong contenteditable="true">Historiska bolagsengagemang</strong>
                                            </p>
                                            <table id="table-6" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-6_col1[]" value="Picnic Sverige Handelsbolag">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-6_col2[]" value="">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-6_col1[]" value="Bergving, Niklas (Enskild firma)">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-6_col2[]" value="">
                                                        </td>
                                        ...
                                        <div data-table-id="table-10" class="tables grab-elements" style="overflow-x: auto;">
                                            <p class="mt-2" data-table-id="table-10">
                                                <i style="cursor: grabbing;" class="bi bi-grip-vertical ui-sortable-handle"></i>
                                                <strong contenteditable="true">Körkort</strong>
                                            </p>
                                            <table id="table-10" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col1[]" value="Körkortsbehörighet">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col2[]" value="">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col1[]" value="Återkallelse av körkort">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col2[]" value="">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col1[]" value="Antal fordon">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col2[]" value="">
                                                        </td>
                                        ...
                                        <div data-table-id="table-2" style="overflow-x: auto" class="tables grab-elements">
                                            <p class="mt-2" data-table-id="table-2">
                                                <i style="cursor: grab" class="bi bi-grip-vertical"></i>
                                                <strong contenteditable="true">Folkbokföringsadress</strong>
                                            </p>
                                            <table id="table-2" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Folkbokföringsadress" class="sign-input form-control" name="table-2_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                        ...
                                        <div data-table-id="table-7" class="tables grab-elements" style="overflow-x: auto;">
                                            <p class="mt-2" data-table-id="table-7">
                                                <i style="cursor: grabbing;" class="bi bi-grip-vertical ui-sortable-handle"></i>
                                                <strong contenteditable="true">Fordonskontroll</strong>
                                            </p>
                                            <table id="table-7" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-7_col1[]" value="Personbil RHY54K">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-7_col2[]" value="">
                                                        </td>
                                                        <td>
                                        ...
                                        <div data-table-id="table-8" class="tables grab-elements" style="overflow-x: auto;">
                                            <p class="mt-2" data-table-id="table-8">
                                                ...
                                                <strong contenteditable="true">Fastighetsinnehav</strong>
                                            </p>
                                            <table id="table-8" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-8_col1[]" value="Ulricehamn Braxen 9">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-8_col2[]" value="">
                                                        </td>
                                                        <td>
                                        ...
                                        <div data-table-id="table-9" class="tables grab-elements" style="overflow-x: auto;">
                                            <p class="mt-2" data-table-id="table-9">
                                                <i style="cursor: grab;" class="bi bi-grip-vertical ui-sortable-handle"></i>
                                                <strong contenteditable="true">PEP/Sanktion</strong>
                                            </p>
                                            <table id="table-9" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-9_col1[]" value="PEP/Sanktion">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-9_col2[]" value="">
                                                        </td>
                                                        <td>
                                        ...
                                        <div data-table-id="table-11" class="tables grab-elements" style="overflow-x: auto;">
                                            <p class="mt-2" data-table-id="table-11">
                                                <i style="cursor: grab;" class="bi bi-grip-vertical ui-sortable-handle"></i>
                                                <strong contenteditable="true">CV-kontroll arbetsgivare</strong>
                                            </p>
                                            <table id="table-11" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col1[]" value="Arbetsgivare 1">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col2[]" value="">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col1[]" value="Befattning">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col2[]" value="">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col1[]" value="Anställningstid">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col2[]" value="">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col1[]" value="Refrensperson">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col2[]" value="">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col1[]" value="-">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col2[]" value="-">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col1[]" value="Arbetsgivare 2">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-11_col2[]" value="">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select class="form-select" name="table-11_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                                <option value="Avvikelse" selected="selected">Avvikelse</option>
                                                                <option value="Nekad">Nekad</option>
                                                                <option value="-">-</option>
                                                            </select>
                                                        </td>
                                        ...
                                        <div data-table-id="table-12" class="tables grab-elements" style="overflow-x: auto;">
                                            <p class="mt-2" data-table-id="table-12">
                                                <i style="cursor: grabbing;" class="bi bi-grip-vertical ui-sortable-handle"></i>
                                                <strong contenteditable="true">CV-kontroll högre eftergymnasial utbildning</strong>
                                            </p>
                                            <table id="table-12" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-12_col1[]" value="Institut 1 ">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-12_col2[]" value="">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-12_col1[]" value="Utbildning">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-12_col2[]" value="">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-12_col1[]" value="Examen ">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-12_col2[]" value="">
                                                        </td>
                                        ...
                                        <div class="comment text mb-3 grab-elements" style="">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="comment_headings[]" required="" class="sign-input form-control w-100 mb-3 comment_headings" placeholder="Text heading " value="SOCIALA MEDIER">
                                            </div>
                                            <div class="col-lg-12">
                                                <p class="f-16 mb-0 pb-0 w-600">Text Description</p>
...
Niklas har ett aktivt konto på Facebook, men vi har observerat att hans aktivitet på denna plattform är begränsad. Under den aktuella undersökningsperioden fann vi inga nyligen publicerade inlägg eller interaktioner på hans Facebook-konto. Det verkar som om Niklas använder Facebook främst för att hålla kontakten med vänner och bekanta, utan någon uttalad aktivitet för att skapa eget innehåll.
Instagram:
På Instagram har Niklas också ett konto, men även här är hans aktivitet ganska begränsad. Inga nyligen publicerade bilder, inlägg eller interaktioner har noterats under den granskade tidsperioden. Niklas verkar använda Instagram för att konsumera innehåll och följa aktiviteter från andra användare.
Linkedin:
Linkedin är den sociala medieplattformen där Niklas är mest aktiv. Han har ett väl underhållet Linkedin-konto med regelbundna inlägg och engagerande uppdateringar. Vi noterade flera professionella inlägg som fått kommentarer och gillanden från hans nätverk, vilket visar på hans aktiva deltagande i branschdiskussioner och professionella nätverkande.
TikTok:
Vi har också observerat att Niklas har ett konto på Tiktok, där användare delar korta videoklipp. Under den aktuella undersökningsperioden noterade vi inga publicerade videor på hans konto.
Avvikelser:
Vi har inte funnit några avvikelser eller oegentligheter på någon av Niklas sociala mediekonton, inklusive Facebook, Instagram, Linkedin och Tiktok. Alla konton verkar vara äkta och följer de allmänna användarvillkoren för respektive plattform.
Slutsats:
Niklas är mest aktiv på Linkedin, där han regelbundet deltar i professionella diskussioner och nätverkande. Facebook och Instagram används huvudsakligen för att hålla kontakten med vänner och bekanta, medan aktiviteten på Tiktok är begränsad. Ingen misstänkt aktivitet eller avvikelser har påvisats på någon av Niklas sociala mediekonton.Efter en omfattande och professionell bakgrundskontroll kan det fastställas att Niklas har en pålitlig och trovärdig bakgrund utan några avvikelser eller negativa indikationer. Personuppgifterna har verifierats och bekräftats som korrekta och övertygande.
                                                        </textarea>
                                                <select id="" class="form-select mb-3">
                                                    <option value="left">Left</option>
                                                    <option value="justify">Justify</option>
                                        ...
                                        <div class="comment text mb-3 grab-elements" style="">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="comment_headings[]" required="" class="sign-input form-control w-100 mb-3 comment_headings" placeholder="Text heading " value="KÄLLOR">
                                            </div>
                                            <div class="col-lg-12">
                                                <p class="f-16 mb-0 pb-0 w-600">Text Description</p>
                                                <textarea name="comment_description[]" id="" required="" placeholder="Text description" rows="3" class="w-100 sign-textarea mb-3 comment_descriptions" spellcheck="true">Recway utför bakgrundskontroller där antalet källor som kontrolleras varierar beroende på omfattningen av kontrollen. Recway hämtar offentliga uppgifter från flera myndigheter och institutioner i Sverige, inklusive Skatteverket, Kronofogdemyndigheten, Centrala studiestödsnämnden, aktuella lärosäten, Transportstyrelsen, Högsta domstolen, Arbetsdomstolen samt samtliga Sveriges hovrätter, tings- och förvaltningsrätter. För att säkerställa en omfattande kontroll inkluderar de också information från öppna källor på internet samt ett urval av de mest populära sociala medie-plattformarna som används idag. Genom att kombinera dessa källor ger Recway en grundlig och pålitlig bakgrundskontroll.</textarea>
                                                <select id="" class="form-select mb-3">
                                                    <option value="left">Left</option>
                                                    <option value="justify">Justify</option>
                                                </select>
                                        ...
                                        <div class="comment text mb-3 grab-elements" style="">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="comment_headings[]" required="" class="sign-input form-control w-100 mb-3 comment_headings" placeholder="Text heading " value="ANSVAR">
                                            </div>
                                            <div class="col-lg-12">
                                                <p class="f-16 mb-0 pb-0 w-600">Text Description</p>
                                                <textarea name="comment_description[]" id="" required="" placeholder="Text description" rows="3" class="w-100 sign-textarea mb-3 comment_descriptions" spellcheck="true">Rapporten får användas av endast Beställaren och får ej spridas till annan. Recway ansvarar inte gentemot annan än Beställaren för innehållet i rapporten eller för annan användning av rapporten än i samband med en bakgrundskontroll. Recway ansvarar ej för eventuella fel i de källor vi hämtar uppgifter från. </textarea>
                                                <select id="" class="form-select mb-3">
                                                    <option value="left">Left</option>
                                                    <option value="justify">Justify</option>
                                                </select>
                                        ...
                                        <div class="comment text mb-3 grab-elements">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="comment_headings[]" required="" class="sign-input form-control w-100 mb-3 comment_headings" placeholder="Text heading " value="METOD">
                                            </div>
                                            <div class="col-lg-12">
                                                <p class="f-16 mb-0 pb-0 w-600">Text Description</p>
...
Bakgrundskontrollen baseras på vid kontrolltillfället tillgänglig information från lagligen åtkomliga källor. Rapporten utgör beslutsunderlag och innebär inte ett anställnings- eller affärsbeslut.
                        ...
                        <?php if (isset($for_customer) && ! empty($for_customer)) { ?>
                            <div class="col-lg-6 ">
                                <button type="button" id="preview" data-bs-toggle="modal"
                                    ...
                                    class="btn-primary-sm bg-primary w-100 mt-4 mx-0 report-btn"><a>Preview
                                        Report</a></button>
                            </div>
                            <div class="col-lg-6 ">
                        ...
                        <?php if (isset($service) && ! empty($service)) { ?>
                            <div class="col-lg-6 ">
                                <button type="button" class="btn-primary-sm bg-primary w-100 mt-4 mx-0" onclick="save_report_service();">Save Report For Service</button>
                            </div>
                        <?php } else { ?>
                            <div class="col-lg-4 ">
                    ...
                    <div class="row bg-1" style="display: none;">
                        <div id="report-html">
                            <?php if (! empty($report_html)) : ?>
                                <?php echo $report_html->report_data ?>
                            <?php else : ?>
                                ...
                                <?php else : ?>
                                    <div class="elements">
                                        ...
                                        <div class="introduction text grab-elements">
                                            ...
                                            <div class="col-lg-12">
                                                <p class="f-16 mb-0 pb-0 w-600">Introduction</p>
                                                <textarea name="intro" id="" required placeholder="Introduktion" rows="3" class="w-100 sign-textarea mb-3">Vi på Recway AB är glada över att ha fått i uppdrag av Recway AB att genomföra ett noggrant Background check - Level 3. Detta är en viktig process för att säkerställa att den potentiella kandidaten är lämplig och pålitlig för tjänsten i fråga. Genom att undersöka individens kriminella historia, utbildning, anställningshistoria och ekonomiska status kan vi identifiera eventuella varningstecken och minska risken för tjänstefel. Vi är ett företag som lägger stor vikt vid integritet och säkerhet och vi kommer att genomföra denna kritiska process med största omsorg och professionalism.</textarea>
                                                <select id="" class="form-select mb-3">
                                                    <option value="left">Left</option>
                                                    <option value="justify">Justify</option>
                                                </select>
                                        ...
                                        <div class="background text grab-elements">
                                            ...
                                            <div class="col-lg-12">
                                                <p class="f-16 mb-0 pb-0 w-600">Background Text</p>
                                                <textarea name="background" id="" required placeholder="Background" rows="3" class="w-100 sign-textarea mb-3">Recway genomförde en bakgrundskontroll på Johan Testsson. Denna rapport innehåller en beskrivning av uppdraget, en sammanfattning av vår analys och en sammanfattning av den information som samlats in.</textarea>
                                                <select id="" class="form-select mb-3">
                                                    <option value="left">Left</option>
                                                    <option value="justify">Justify</option>
                                                </select>
                                        ...
                                        <div class="comment text mb-3 grab-elements" style="">
                                            ...
                                            <div class="col-lg-12">
                                                <p class="f-16 mb-0 pb-0 w-600">Text Description</p>
                                                <textarea name="comment_description[]" id="" required="" placeholder="Text description" rows="3" class="w-100 sign-textarea mb-3 comment_descriptions" spellcheck="true">Denna rapport ämnar att beskriva och analysera två viktiga aspekter som framkommit under vår bakgrundskontroll av Johan, nämligen avvikelsen i hans CV och en betalningsanmärkning som har identifierats i hans ekonomiska historik. Nedan redogörs för dessa två områden. 
Avvikelse i CV
Vid granskning av Johans CV har det framkommit en avvikelse som kräver närmare undersökning. En anställning vid Fordon AB har nämnts, men det har inte varit möjligt att verifiera denna anställning genom våra vanliga kanaler. Trots efterfrågat arbetsintyg från Johan gällande hans anställning vid Fordon AB har vi ännu inte mottagit detta, vilket fortsätter att skapa osäkerhet kring den exakta karaktären av denna erfarenhet och behovet av ytterligare klarläggande från Johans sida.
Betalningsanmärkning:
Under den ekonomiska bakgrundskontrollen har en betalningsanmärkning upptäckts i sambandmed Johans namn. Denna anmärkning har noterats och kräver ytterligare analys. Det är viktigt att påpeka att en betalningsanmärkning, även om den är en negativ aspekt av hans ekonomiska historik, inte nödvändigtvis påverkar andra områden av hans bakgrund, såsom arbetsprestation eller personlig integritet. Johans ekonomiska historik utöver denna anmärkning är fortfarande stabil och pålitlig.
Sammanfattningsvis, avseende avvikelsen i hans CV, måste det noteras att trots efterfrågat arbetsintyg från Johan gällande hans anställning vid Fordon AB har vi ännu inte mottagit detta. När det gäller betalningsanmärkningen, måste det noteras att detta är en negativ aspekt av hans ekonomiska historik, men den påverkar inte andra aspekter av hans bakgrund. Johan bedöms fortfarande vara en pålitlig individ med en ren och trovärdig bakgrund, förutom denna ekonomiska anmärkning.
</textarea>
                                                <select id="" class="form-select mb-3">
                                                    <option value="left">Left</option>
                                                    <option value="justify">Justify</option>
                                            ...
                                            <table id="table-5" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" value="0" class="sign-input form-control" name="table-5_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-5_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="1 50 000" name="table-5_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-5_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                                <option value="Avvikelse" selected>Avvikelse</option>
                                                                <option value="Nekad">Nekad</option>
                                                            </select>
                                                        </td>
                                                        <td>
                                            ...
                                            <table id="tableIncome" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" value="678 876" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="123 321" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="456 654" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="tableIncome_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" value="- 600 000" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="- 250 000" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="- 340 000" class="sign-input form-control">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="tableIncome_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                            ...
                                            <table id="table-0" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Förekommer ej" name="table-0_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-0_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" value="Förekommer ej" class="sign-input form-control" name="table-0_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-0_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                        ...
                                        <div data-table-id="table-1" style="overflow-x: auto" class="tables grab-elements">
                                            ...
                                            <table id="table-1" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="testgatan 20" class="sign-input form-control" name="table-1_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="sedan 2019-05-26" class="sign-input form-control" name="table-1_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-1_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                        ...
                                        <div data-table-id="table-6" class="tables grab-elements" style="overflow-x: auto;">
                                            ...
                                            <table id="table-6" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-6_col1[]" value="Personbil RHZ076">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="äger sedan 2021" class="sign-input form-control" name="table-6_col2[]" value="">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-6_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                        ...
                                        <div data-table-id="table-10" class="tables grab-elements" style="overflow-x: auto;">
                                            ...
                                            <table id="table-10" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col1[]" value="Testfastighet 5">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col2[]" value="äger sedan 1999">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-10_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                        ...
                                        <div data-table-id="table-2" style="overflow-x: auto" class="tables grab-elements">
                                            ...
                                            <table id="table-2" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Arbetsgivare 1" class="sign-input form-control" name="table-2_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Vattenfall AB" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Befattning" class="sign-input form-control" name="table-2_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Utvecklare" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Anställningstid" class="sign-input form-control" name="table-2_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="2022-01-01 - 2023-04-01" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Refrensperson" class="sign-input form-control" name="table-2_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Carl Johan" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="-" class="sign-input form-control" name="table-2_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="-" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" value="Arbetsgivare 2" class="sign-input form-control" name="table-2_col1[]">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Energi AB" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Mätingenjör" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="2020-02-01 - 2021-12-15" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Johan Svensson" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Fordon AB" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Montör" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="1998-02-01 - 2020-01-03" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="sign-input form-control" value="Adam Svensson" name="table-2_col2[]">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-2_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                        ...
                                        <div data-table-id="table-10" class="tables grab-elements" style="overflow-x: auto;">
                                            ...
                                            <table id="table-10" class="w-100" style="min-width: 722px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col1[]" value="Institut 1">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col2[]" value="Umeå Universistet">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-10_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col1[]" value="Utbildning">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col2[]" value="Dataingejör 120 hp">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-10_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col1[]" value="Examen">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="sign-input form-control" name="table-10_col2[]" value="2000-2006">
                                                        </td>
                                                        <td>
                                                            <select class="form-select" name="table-10_col3[]">
                                                                <option value="Godkänd">Godkänd</option>
                                        ...
                                        <div class="pageBreak mb-3 grab-elements mt-2" style="">
                                            <i style="cursor: grab" class="bi bi-grip-vertical comments-grabber ui-sortable-handle"></i>
                                            <hr>
                                            <div class="col-lg-12 ps-0">
                                                <button type="button" class="btn-primary-sm bg-primary w-auto px-4 m-0 mt-1 text-white delete-page-break">Delete Page Break</button>
                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#add-table').click(function() {
            ...
            $('body').on('click', `.add-row[data-table-id="${tableId}"]`, function() {
                const tableId = $(this).data('table-id');
                const rowHtml = '<tr><td><input type="text" class="sign-input form-control" name="' + tableId + '_col1[]"></td><td><input type="text" class="sign-input form-control" name="' + tableId + '_col2[]"></td><td><select class="form-select" name="' + tableId + '_col3[]"><option value="Godkänd">Godkänd</option><option value="Avvikelse">Avvikelse</option><option value="Nekad">Nekad</option><option value="-">-</option></select></td><td><i style="color: var(--yellow); cursor: pointer" class="delete-row bi bi-trash ms-2" data-table-id="' + tableId + '"></i></td></tr>';
                $(`#${tableId} tbody`).append(rowHtml);
            })
            $('body').on('click', `.delete-table[data-table-id="${tableId}"]`, function() {
                const tableId = $(this).data('table-id');
                $(`#${tableId}`).remove()
                $(`div[data-table-id="${tableId}"]`).remove()
                $(`.add-row[data-table-id="${tableId}"]`).remove()
                $(`p[data-table-id="${tableId}"`).remove()
                $(this).remove()
                // Find the index of the table with matching tableId
...
<script>
    ...
    $(".bg-report-btn").click(function() {
        ...
        var statusImages = {
            "Godkänd": "approved.png",
            "Avvikelse": "deviation.png",
            "Nekad": "denied.png"
        };
        ...
        function addTOC() {
            ...
            for (let i = 0; i < toc_headings.length; i++) {
                ...
                doc.setFontSize(10)
                y = i === 0 ? y + 5 : y
                doc.textWithLink(toc_headings[i].toUpperCase(), leftMargin + 10, y + 5, {
                    pageNumber: toc_numbers[[toc_headings[i]]]
                });
                ...
                doc.textWithLink(toc_numbers[[toc_headings[i]]].toString(), doc.internal.pageSize.width - rightMargin - 10, y + 5, {
                    pageNumber: toc_numbers[[toc_headings[i]]]
                });
                y += 5
            }
        ...
        function addInformation() {
            ...
            textFont("title")
            doc.setTextColor("#000000")
            doc.text('Bakgrundskontroll - Bas', leftMargin, y)
            y = y + 3
            doc.setLineWidth(1)
            doc.setDrawColor(primaryColorRGB[0], primaryColorRGB[1], primaryColorRGB[2])
        ...
        function addProfile() {
            ...
            let profileHeading = "Personlig information".toUpperCase();
            ...
            summary_items["Personlig information"] = $(".profile-summary").val()
            var data = [{
                    key: "Namn",
                    value: candidate.name + " " + 'Johan Testsson'
                },
                {
                    key: "E-post",
                    value: 'Johan.testson@gmail.com'
                },
                {
                    key: "Telefon",
                    value: '070-123123123'
        ...
        $(".elements").find(".grab-elements:visible").each(function() {
            if ($(this).hasClass("pageBreak")) {
                ...
                const tableData = [];
                const table = {}
                const tableCaption = $(this).find('strong').text().trim()
                ...
                var align = $(this).find('select').val()
                tableExists = false
                textFont("normalText")
                var lines = doc.splitTextToSize(description, doc.internal.pageSize.width - (leftMargin + rightMargin));
                ...
                let headingText = heading.toUpperCase();
                let headingMaxWidth = doc.internal.pageSize.width - leftMargin - rightMargin;
                let headingSplitText = doc.splitTextToSize(headingText, headingMaxWidth);
                headingSplitText = headingSplitText.filter(line => line.trim() !== "");
                let headingLineSpacing = 7;

                for (let j = 0; j < headingSplitText.length; j++) {
                    doc.text(headingSplitText[j], leftMargin, y + (j * headingLineSpacing));
                }

                y = y + (headingSplitText.length - 1) * headingLineSpacing + 2;
                doc.setLineWidth(0.6)
                doc.setDrawColor(primaryColorRGB[0], primaryColorRGB[1], primaryColorRGB[2])
                doc.line(leftMargin, y, leftMargin + 10, y)
        ...
        function addSummary() {
            ...
            doc.addImage("../assets/reportbg3.webp", 'WEBP', 0, 0, imgWidth, imgHeight);
            addHeader()
            addFooter()
            y = 30
            doc.setTextColor("#ffffff")
            textFont("mainHeading")
            doc.text("Sammanfattning".toUpperCase(), leftMargin, y)
            textFont("subHeading")
            doc.text("Översikt per delområde", leftMargin, y + 7)
            ...
            for (var i = 0; i < toc_headings.length; i++) {
                if (toc_headings[i] !== "Sammanfattning" && summary_items[toc_headings[i]] !== "None") {
            ...
            y += 85
            // Set the text color to white and font size
            doc.setTextColor(255, 255, 255); // White color
            doc.setFontSize(10); // Set font size to 10
            const rectWidth = 50;
            const rectHeight = 5;
            const startX = 15; // Starting x position for rectangles
            const startTextX = 71; // Starting x position for text
            const startY = 43; // Starting y position
            const spacing = 5; // Space between each rectangle-text pair vertically
            const texts = [
                'SUMMERING',
                'EKONOMI',
                'INKOMSTUPPGIFTER',
                ...
                'CV-KONTROLL HÖGRE EFTERGYMNASIAL UTBILDNING'
            ];
            for (let i = 0; i < texts.length; i++) {
                const currentY = startY + i * (rectHeight + spacing);
                // Set the fill color based on the text
                if (texts[i] === 'EKONOMI' || texts[i] === 'CV-KONTROLL ARBETSGIVARE') {
                    doc.setFillColor(252, 164, 4); // Set fill color to #fca404
                } else {
                    doc.setFillColor(60, 180, 116); // Set fill color to #3cb474
                }
                // Draw a filled rectangle
                doc.rect(startX, currentY, rectWidth, rectHeight, 'F');
                // Add text next to the rectangle
                doc.text(texts[i], startTextX, currentY + 3); // Adjust the x and y coordinates as needed
            }
            textFont("mainHeading")
            y += 5
            doc.text("DEFINITIONER", leftMargin, y)
            y += 7
            textFont("subHeading")
            doc.text("DEFINITION", leftMargin, y)
            doc.text("FÄRGKOD", doc.internal.pageSize.getWidth() - rightMargin - 22, y)
            y += 5
            doc.setLineWidth(0.6)
            doc.setDrawColor(255, 255, 255)
            doc.line(leftMargin, y, doc.internal.pageSize.getWidth() - rightMargin, y)
            y += 10
            doc.text("INGA AVVIKELSER", leftMargin, y + 2)
            doc.setLineWidth(10)
            ...
            y += 15
            doc.text("NOTERBARA AVVIKELSER", leftMargin, y + 2)
            doc.setLineWidth(10)
            doc.setDrawColor(255, 166, 0)
            doc.line(doc.internal.pageSize.getWidth() - rightMargin - 10, y, (doc.internal.pageSize.getWidth() - rightMargin), y)
            y += 15
            doc.text("ANMÄRKNINGSVÄRDA AVVIKELSER", leftMargin, y + 2)
            doc.setLineWidth(10)
        ...
        var imgHeight = doc.internal.pageSize.getHeight(); // Get the height of the page
        // Add the image to the document
        doc.addImage("../assets/reportbg2.webp", 'WEBP', 0, 0, imgWidth, imgHeight);
        doc.setTextColor("#ffffff")
        doc.setFontSize(20);
        doc.text("BAKGRUNDSKONTROLL", leftMargin, 80)
        doc.setFontSize(32)
        doc.text('BAS', leftMargin, 95)
        doc.setDrawColor(255, 255, 255)
        doc.setLineWidth(1)
        ...
        function addTotalPages() {
            ...
            for (var i = 0; i < pageCount; i++) {
                ...
                doc.setFont("Helvetica", "Bold")
                doc.setTextColor("#ffffff")
                doc.text((i + 1) + " | " + totalPages[i], doc.internal.pageSize.width - 18, doc.internal.pageSize.height - 6);
            }
        }
        addTotalPages()
        ...
        if ($(this).attr("id") === "preview") {
            $('#backgroundReportframe').attr('src', blobURL)
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#reportModal .modal-body").append(`<p style="overflow: hidden;white-space: nowrap; text-overflow: ellipsis" class="mb-0 w-100 f-18 p-0 pt-1"><a target="_blank" href="../report-uploads/${candidate.order_id}.pdf" style="cursor: pointer" class="text-success">${candidate.order_id}.pdf</a></p>`)
    ...
    $(".report-btn").click(function() {
        ...
        //         doc.setFontSize(10);
        //         // y = i === 0 ? y + 5 : y;
        //         let headingText = toc_headings[i].toUpperCase();
        //         let pageNum = toc_numbers[toc_headings[i]].toString();
        //         let pageLink = { pageNumber: toc_numbers[toc_headings[i]] };
        //         let maxWidth = doc.internal.pageSize.width - leftMargin - rightMargin - 50;
        //         let splitText = doc.splitTextToSize(headingText, maxWidth);
        //         splitText = splitText.filter(line => line.trim() !== "");
        //         // console.log(splitText,'hello');
        //         // Draw heading (only first line is clickable)
        //         doc.textWithLink(splitText[0], leftMargin + 10, y + 5, pageLink);
        //         // Draw rest of lines without link
        //         for (let j = 1; j < splitText.length; j++) {
        //             doc.text(splitText[j], leftMargin + 10, y + 5 + (j * 5));
        //         }
        //         // Draw page number as link (aligned with first line)
        //         doc.textWithLink(pageNum, doc.internal.pageSize.width - rightMargin - 10, y + 5, pageLink);
        //         // Dotted line on first line only
        //         let firstLineWidth = getTextWidth(splitText[0], doc.getFontSize());
        //         let pageNumWidth = getTextWidth(pageNum, doc.getFontSize());
        //         doc.setLineWidth(0.2);
        //         doc.setLineDash([1, 1]);
        //         doc.setDrawColor(0, 0, 0);
        //         doc.line(
        //             leftMargin + 10 + firstLineWidth + 3,
        //             y + 5,
        //             doc.internal.pageSize.width - rightMargin - pageNumWidth - 12,
        //             y + 5
        //         );
        //         // Update y: total height = number of lines × line height (5)
        ...
        function addTOC() {
            ...
            doc.text("INNEHÅLL", (doc.internal.pageSize.width / 2) - 20, 30)
            for (let i = 0; i < toc_headings.length; i++) {
                // Guard against undefined headings
                if (!toc_headings[i]) continue;
                
                const currentHeading = toc_headings[i];
                const pageNum = toc_numbers[currentHeading];
                
                // Guard against undefined page number
                if (typeof pageNum === 'undefined') {
                    console.warn('Missing page number for heading:', currentHeading);
                    continue;
                }
                
                textFont("subHeading");
                doc.setFontSize(10);
                let headingText = String(currentHeading).toUpperCase();
                let pageNumStr = String(pageNum);
                let pageLink = { pageNumber: pageNum };
                let maxWidth = doc.internal.pageSize.width - leftMargin - rightMargin - 50;
                let splitText = doc.splitTextToSize(headingText, maxWidth);
                splitText = splitText.filter(line => line.trim() !== "");
                
                // Guard against empty split text
                ...
                // Draw page number as link (aligned with first line)
                doc.textWithLink(pageNumStr, doc.internal.pageSize.width - rightMargin - 10, y + 5, pageLink);
                // Dotted line on first line only
                let firstLineWidth = getTextWidth(splitText[0], doc.getFontSize());
                let pageNumWidth = getTextWidth(pageNumStr, doc.getFontSize());
                doc.setLineWidth(0.2);
                doc.setLineDash([1, 1]);
                doc.setDrawColor(0, 0, 0);
                doc.line(
        ...
        function addSummary() {
            ...
            y += 17
            for (var i = 0; i < toc_headings.length; i++) {
                let heading = toc_headings[i].trim();
                if (toc_headings[i] !== "Sammanfattning" && summary_items[toc_headings[i]] !== "None") {
                    var value = summary_items[toc_headings[i]]
                    doc.setFontSize(10)
                    doc.setLineWidth(5)
                    ...
                    let splitText = doc.splitTextToSize(headingText, maxWidth);
                    splitText = splitText.filter(line => line.trim() !== "");
                    // 👉 Draw each line of the heading manually
                    for (let j = 0; j < splitText.length; j++) {
                        doc.text(splitText[j], leftMargin + 55, y + 1 + (j * 5));
                    }
                    // 👉 Update Y properly based on how many lines were printed
        ...
        var imgHeight = doc.internal.pageSize.getHeight(); // Get the height of the page
        var leftMargin = 10;
        var maxTextWidth = imgWidth - 2 * leftMargin;
        // Add the image to the document
        doc.addImage("../assets/reportbg2.webp", 'WEBP', 0, 0, imgWidth, imgHeight);
        doc.setTextColor("#ffffff")
        doc.setFontSize(20);
        ...
        var serviceTitleLines = doc.splitTextToSize(candidate.serviceTitle, maxTextWidth);
        doc.text(serviceTitleLines, leftMargin, 95);
    ...
    $("#save_comp").click(function() {
        var html = $("#report-html").html();
        // var company = $.trim(customer.company);
        var customer = candidate.cus_id;
        var interview_id = $.trim(candidate.interview_id);
        $("#report-msg").removeClass()
        $("#report-msg").addClass("text-center text-danger")
        $("#report-msg").text("Please wait while saving the report...")
        $.ajax({
    ...
    function dropdown_chng(obj) {
        $($(obj).find('option')).each(function() {
            if ($(obj).val() == $(this).val()) {} else {
                $(this).attr('selected', false);
            }
        })
    }
    $('.form-select').each(function() {
        $(this).attr('onchange', 'dropdown_chng(this)')
    })
    $('.form-select').each(function() {
        $(this).attr('onchange', 'dropdown_chng(this)')
    });
    $(document).ready(function() {
        $('#backgroundCheckSelect').on('change', function() {
    ...
    function bk_1() {
        var bk1 = `<div class="col-lg-12 grab-elements">
    <p class="f-16 mb-0 pb-0 w-600">Result</p>
    <select name="result" id="" class="form-select mb-3">
        <option value="Godkänd">Godkänd</option>
        <option value="Avvikelse">Avvikelse</option>
...
Det är dock viktigt att notera att Recway inte kan identifiera eller upptäcka alla möjliga uppgifter om kandidaten. Bakgrundskontrollerna ger en grundlig bedömning baserat på tillgänglig information, men det finns ingen garanti för att all relevant information kan inhämtas.</textarea>
    ...
    <div class="col-lg-12 ps-0">
        ...
        $('form').find('.elements').html(bk1)
        flash("successMsg", "Report Changed to background check level 1")
    }
    function bk_2() {
        var bk2 = `<div class="col-lg-12 grab-elements">
    <p class="f-16 mb-0 pb-0 w-600">Result</p>
    <select name="result" id="" class="form-select mb-3">
        <option value="Godkänd">Godkänd</option>
        <option value="Avvikelse">Avvikelse</option>
...
Vi har inte funnit några avvikelser eller oegentligheter på någon av Niklas sociala mediekonton, inklusive Facebook, Instagram, Linkedin och Tiktok. Alla konton verkar vara äkta och följer de allmänna användarvillkoren för respektive plattform.
Slutsats:
Niklas är mest aktiv på Linkedin, där han regelbundet deltar i professionella diskussioner och nätverkande. Facebook och Instagram används huvudsakligen för att hålla kontakten med vänner och bekanta, medan aktiviteten på Tiktok är begränsad. Ingen misstänkt aktivitet eller avvikelser har påvisats på någon av Niklas sociala mediekonton..
                </textarea>
        <select id="" class="form-select mb-3">
            <option value="left">Left</option>
            <option value="justify">Justify</option>
...
Det är dock viktigt att notera att Recway inte kan identifiera eller upptäcka alla möjliga uppgifter om kandidaten. Bakgrundskontrollerna ger en grundlig bedömning baserat på tillgänglig information, men det finns ingen garanti för att all relevant information kan inhämtas.</textarea>
    ...
    <div class="col-lg-12 ps-0">
        ...
        $('form').find('.elements').html(bk2)
        flash("successMsg", "Report Changed to background check level 2")
    }
</script>
<script>
        function save_report_for_customer(obj){
            if (obj) {
        let $form = $("#report-html").clone();
        // Iterate over all form elements to ensure current states are reflected in the HTML
        $form.find("input, textarea, select, button").each(function () {
            let $this = $(this);
            if ($this.is("input[type='checkbox'], input[type='radio']")) {
                // For checkboxes and radios, set the checked attribute based on current state
                ...
                // For textareas, update the inner text
                $this.text($this.val());
            } else if ($this.is("select")) {
                // For selects, set the selected attribute for each selected option
                ...
                // For buttons, ensure their text and attributes are preserved
                $this.html($this.html());
            }
        });
        let html = $form.prop("outerHTML");
            $.ajax({
                type: "POST",
            url: "../includes/ajax.php",
            data: {
