...
<!-- <script src="assets/js/interview_template.js"></script> -->
...
<script>
    ...
    // function showScrollButtonsIfRowVisible() {

    //     var tableRow = $('#table tr:nth-child(10)');

    //     var tableRowTop = tableRow.offset().top;
    ...
    //     if (tableRowTop <= viewportBottom) {

    //         $('#scrollLeftButton, #scrollRightButton').fadeIn('2000');

    //     } else {

    //         $('#scrollLeftButton, #scrollRightButton').hide();
