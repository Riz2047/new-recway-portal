                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select id="interview" name="interview" class="form-control filter-select"
                                            onchange="get_form_of();check_p_c(this);check_combine_bk_and_security()">
                                            <?php foreach ($interviews as $interview): ?>
                                                <option value="<?php echo $interview->id ?>" <?php echo isset($interview_id) && $interview_id == $interview->id ? 'selected' : '' ?>>
                                                    <?php echo $interview->title ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="sendMail" value="yes"
                                                    checked id="gridCheck">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="sendMail" value="no"
                                                    id="gridCheck2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="sendMailCan"
                                                    value="yes" checked id="gridCheck3">
                                ...
                                <div class="row" id="billing_info_row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <br>
                                        <textarea name="comment" id="" style="width: 100%;" rows="6"
                                            placeholder="Invoice Comment (Visible on the invoice)"></textarea>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="note" id="" style="width: 100%;" rows="6"
                                            placeholder="Here you can create a note about the order that is visible to both you and us. Please note that this note will not be visible to the individual."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            $.each(personal_info, function(p, v) {
                                ...
                                if (real_data != '') {
                                    ...
                                    if (name === 'security') {
                                        ...
                                        per_info_html += `<div class="col-md-6 col-sm-12 mb-2"><label>${name}</label><select class="form-control select-ui" ` + (is_new ? `name="form_builder[` + label + `]"` : `name="` + name + `"`) + `>`;
                                        if (placehol) {
                            ...
                            $.each(billing_info, function(p, v) {
                                ...
                                if (real_data != '') {
                                    ...
                                    if (type === 'select') {
                                        ...
                                        bil_info_html += `<div class="col-md-6 col-sm-12 mb-2"><label>${name}</label><select class="form-control select-ui" ` + (is_new ? `name="form_builder[` + label + `]"` : `name="` + name + `"`) + `>`;
                                        if (placehol) {
