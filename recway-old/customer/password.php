...
if(isset($_POST['submit'])) {
    ...
    if($res) {
        ...
        $message = '<p class="text-danger">Cannot change password! Try again later.</p>';
    }
}
    ...
    <div class="row">
        ...
        <div class="col-lg-6 d-md-block d-none">
            <div class="d-flex justify-content-center align-items-center">
                <img src="assets/images/log-in.png" alt="" class="img-fluid">
            </div>
        </div>
        <div class="col-lg-6">
            ...
            <div class="grey-box">
                ...
                <form action="" method="post" class="form">
                    ...
                    <div class="d-flex align-items-center form-row mb-2">
                      ...
                      <input id="password" type="password" name="password" placeholder="Enter password" class="w-100 from-input">
                      ...
                      <div class="mt-3 mb-1 log-btn-div">
                        <button type="submit" name="submit" class="log-btn ">Reset</button>
                      </div>
