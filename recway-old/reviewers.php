...
$reviewers = findAllByQuery("SELECT * FROM reviewers WHERE cus_id = {$_SESSION['customer']->id}");
...
<!--                                            <li class="mb-1"><a class="no-decoration f-14 w-600 text-black " href="update-reviewer.php?id=--><?php //echo $reviewer->id ?><!--"><i-->
<!--                                                            class="bi bi-pen text-black f-14 me-2"></i>-->
<!--                                                    Edit</a></li>-->
                                            <li class="mb-1"><a class="no-decoration f-14 w-600 text-black " href="?id=<?php echo $reviewer->id ?>"><i
                                                            class="bi bi-trash text-black f-14 me-2"></i>
                                                    Delete</a></li>
                                        </ul>
                                    </div>
