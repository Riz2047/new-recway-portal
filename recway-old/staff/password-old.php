      ...
      <div class="container">
        <div class="row sign-row d-flex justify-content-center align-items-center">
          <form method="post" class="col-lg-9 sign-form mx-auto">
            ...
            <p class="f-16 mb-0 pb-0 w-600">Enter new password</p>
            <input type="password" name="password" required class="sign-input w-100 mb-3" placeholder="Password ">

            <button type="submit" name="submit" class="btn-fill mt-4 mx-0"><a>Change</a></button>
