                ...
                <div class="white-box-p-0 h-100">
                    <div class="tab">
                        ...
                        <?php if (isset($allowed_staff_permission['update_customer']) && ! empty($allowed_staff_permission['update_customer'])) { ?>
                            <button class="tablinks f-12 w-700 " id="defaultOpen" onclick="openCity(event, 'edit')">Edit Customer</button>
                                    ...
                                    <div class="col-lg-12">
                                        <?php if (! empty($services)) : ?>
                                            <div class="col-lg-12 mb-3 p-0">
                                                <select class="form-control filter-select" name="services" id="service-messages">
                                                    <?php foreach ($services as $service) : ?>
...
<script>
    ...
    // Resend Email (delegated event handling for dynamically created buttons)
                            ...
                            html = `<tr>
                                    ...
                                    <td style="width:6% !important">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu p-2 ps-3 table-menu-btn-list" >
                                                <li class="mb-1"><a href="#" onclick="openCity(event, 'update_additional_customers'),get_ad_cu_data(this)" data-id="` + response.last_id + `" data-name="` + response.name + `" data-email="` + response.email + `" data-type="1" class="no-decoration f-14 w-600 text-black "><i class="bi bi-pen text-black f-14 me-2"></i>
                                                        Edit</a>
                                                </li>
