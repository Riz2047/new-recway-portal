                            ...
                            <div class="table-section">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea id="comment" placeholder="Comment" rows="3" class="w-100 sign-textarea mb-3 form-control"></textarea>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-4 ">
                                        <button type="button" id="preview" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn-primary bg-primary w-100 mt-4 mx-0 report-btn"><a>Preview Report</a></button>
                                    </div>

                                    <div class="col-lg-4 ">
                                        <button type="button" id="generate" class="btn-primary bg-primary w-100 mt-4 mx-0 report-btn"><a>Generate Report</a></button>
                                    </div>

                                    <div class="col-lg-4 ">
                                        <button type="button" id="submit" class="btn-primary bg-primary w-100 mt-4 mx-0 report-btn"><a>Submit Report</a></button>
                                    </div>
                                </div>
