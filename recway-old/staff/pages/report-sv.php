...
<script>
    ...
    $(".bg-report-btn").click(function() {
        ...
        function addProfile() {
            ...
            doc.text("Personlig information".toUpperCase(), leftMargin, y)
                ...
                didDrawPage: function(data) {
                    ...
                    if (!tableHasSplit) {
                        ...
                        if (data.cursor.y < data.settings.startY) {
                            ...
                            let headingText = table.caption.toUpperCase();
                            let maxWidth = doc.internal.pageSize.width - leftMargin - rightMargin - 20;
                            let splitText = doc.splitTextToSize(headingText, maxWidth);
                            splitText = splitText.filter(line => line.trim() !== "");
                            
                            // Draw heading line by line
                            for (let j = 0; j < splitText.length; j++) {
                                doc.text(splitText[j], leftMargin, tableHead + (j * 5));
                            }

                            // Adjust Y based on number of lines
                            // y = tableHead + (splitText.length * 5) + 2;
                            y = tableHead + 2
