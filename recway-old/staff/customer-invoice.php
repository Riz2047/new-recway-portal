...
$(document).ready(function() {
    ...
    var table = $('#invoiceTable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../admin2/includes/invoice_ajax.php",
            "type": "POST",
            "data": function(d) {
...
function exportData() {
    ...
    window.open('../admin2/includes/invoice_ajax.php?' + queryString, '_blank');
}

function exportInvoice(invoiceId) {
    window.open('../admin2/includes/invoice_ajax.php?action=export_invoice&invoice_id=' + invoiceId, '_blank');
}
