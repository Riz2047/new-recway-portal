...
<div class="mx-lg-4 main-content">
    <div class="container">
        <div class="row">
            <div
                class="col-lg-12 d-flex justify-content-md-between flex-md-row flex-column justify-content-center align-items-center">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <span class="me-3">
                        <button class="btn-primary w-600  mb-3" data-bs-toggle="modal"
                            data-bs-target="#customize_columns">
        ...
        <div class="modal fade" id="uninvoiced_orders" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div id="tooltip">
                                <button type="button" class="btn-close float-right m-2" aria-label="Close"
                                    ...
                                    <?php if (!empty($uninvoiced_orders)) {
                                        ...
                                        <?php foreach ($uninvoiced_orders as $uninvoiced_order) { ?>
                                            <tr>
                                                ...
                                                ?>
                                                <td>
                                                    <button class="<?= $class ?>" type="button" aria-expanded="false"
                                                        data-id="<?= $uninvoiced_order->id ?>" onclick="get_history(this)"
                                                        style="float: right;margin: 5px;">
                                                        <i class="bi bi-clock-history"></i>
                                                    </button>
                                                </td>
                                                <td><span class="badge badge-pill"
                                                        style="background-color:<?= $uninvoiced_order->status_color ?>"><?= $uninvoiced_order->status_name ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <input type="checkbox" class="form-check-input"
                                                        data-chkcomp="<?= trim($uninvoiced_order->company_name) ?>"
                                                        value="<?= $uninvoiced_order->order_id ?>"
                                                        id="inv_<?= $uninvoiced_order->order_id ?>"
                                                        onclick="invoice_sent(this)">
                                                    <label for="inv_<?= $uninvoiced_order->order_id ?>"
        ...
        <div class="modal fade" id="cus_with_orders" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="comp_with_orders" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                                    ...
                                    <?php if (!empty($booked_order_comp)) {
                                        ...
                                        <?php foreach ($booked_order_comp as $booked_order_cu) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        value="<?= $booked_order_cu->company ?>"
                                                        id="<?= $booked_order_cu->company ?>" onclick="check_checkboxes(this)">
                                                    <label for="<?= $booked_order_cu->company ?>" class="form-check-label ">
                                                    </label>
                                                </td>
                                                <td>
                                                    <button type="button" data-name="<?= $booked_order_cu->company ?>"
                                                        onclick="trigger_export(this);$(this).addClass('btn-success')"><span
            ...
            <div class="col-lg-6 mb-3 created-main" style="display: <?php echo $status == 1 ? 'block' : 'none' ?>">
                <div class="white-box mt-3 fix-card h-100 height-orders">
                    <div class="d-flex justify-content-between chats-cards mt-2">
                        ...
                        <p class="f-12 w-700 created-title-date">
                            <?php echo Date('d M', strtotime($startDate)) . ' - ' . Date('d M', strtotime($endDate)) ?>
                        </p>
                    </div>
        ...
        <div class="row mt-3 justify-content-center h-100">
            ...
            <div class="col-lg-6 mb-3 company-orders-main"
                style="display: <?php echo $status == 1 ? 'block' : 'none' ?>">
                <div class="white-box mt-3 fix-card h-100 height-orders">
                    <div class="d-flex justify-content-between chats-cards mt-2">
                        ...
                        <div class="col-lg-4 mb-md-0 mb-3">
                            <div class="d-flex flex-column justify-content-between  h-100">
                                ...
                                <div class="d-flex align-items-center buttons">
                                    <a id="cancel-date" data-bs-dismiss="modal"
                                        class="d-flex f-14 w-500 btn-primary-sm w-50 me-2">Cancel</a>
                                    <a id="apply-date" data-bs-dismiss="modal"
                                        class="d-flex f-14 w-500 btn-primary-sm bg-primary w-50 ms-2 apply">Apply</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-md-0 mb-3">
                            ...
                            <form action="" class="update-form">
                                <div class="row p-0 m-0">
                                    <div class="col-lg-3 mb-3">
                                        ...
                                        <select class="form-select  w-100 select2 customer-select"
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        ...
                                        <select class="form-select  w-100 select2 company-select"
                                            aria-label="Default select example" onchange="checkBillingDetail()">
                                            <option selected value="0">All Companies</option>
                                            <?php if (!empty($companies)) { ?>
                                                <?php foreach ($companies as $company) { ?>
                                                    <option value="<?= $company->company ?>"
                                                        data-companyname="<?= $company->company ?>">
                                                        <?= $company->company ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        (<?= $company->order_count ?>)</option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        ...
                                        <select class="form-select  w-100 select2 service-select"
                                            onchange="change_title(this)">
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        ...
                                        <select class="form-select  w-100 select2 lastStatus-select"
                                            aria-label="Default select example">
                                            <option selected value="0">Select Status</option>
                                            <?php if (!empty($last_status)): ?>
                                                <?php foreach ($last_status as $last_statu): ?>
                                                    <option value="<?php echo $last_statu->status ?>">
                                                        <?php echo $last_statu->status ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <label class="interview_label_from">Interview/Delivery Date From</label>
                                        <input type="date" id="startDate" class="form-control"
                                            value="<?php echo $startDate ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="interview_label_to">Interview/Delivery Date To</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex justify-content-between mt-3 mb-3">
                                            ...
                                            <button type="button" id="reset-filters"
                                                class="f-14  w-500 no-decoration text-primary btn-primary-sm bg-primary">Reset
                                                Filters</button>

                                            <div class="d-flex align-items-center ">
                                                <div class="me-3">
                                                    <button type="button" data-bs-dismiss="modal" id="cancel-filter"
                                                        class="f-14 w-500 btn-primary-sm order">Cancel</button>
                                                </div>
                                                <div>
                                                    <button type="button" data-bs-dismiss="modal"
                                                        class=" f-14 w-500 order-fill apply btn-primary-sm bg-primary"
                                                        onclick="apply_filter_2();">Apply</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="">
                                <div class="row bg-light p-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="d-flex align-items-start">
                                            <input <?php echo $status == 1 ? 'checked' : '' ?> value="created-main"
                                                type="checkbox" class="form-check-input" id="created-check"
                                                name="created">
                                            <label style="line-height: 14px" for="created-check"
                                                class="form-check-label ">
                                                Created<br><small class="f-12 p-0 m-0"
                                                    style="font-weight: normal">Number of
                                    ...
                                    <div class="col-12 mb-3 mt-3">
                                        <?php $status = findObjectByValue('approved-main', $analytics)->status ?>
                                        <div class="d-flex align-items-start ">
                                            <input <?php echo $status == 1 ? 'checked' : '' ?> value="approved-main"
                                                type="checkbox" class="form-check-input" id="approved-check"
                                                name="approved">
                                            <label style="line-height: 14px" for="approved-check"
                                                class="form-check-label">Approved<br><small class="f-12 p-0 m-0"
                                                    style="font-weight: normal">Number of
                                    ...
                                    <div class="col-12 mb-3 mt-3">
                                        <?php $status = findObjectByValue('booked-main', $analytics)->status ?>
                                        <div class="d-flex align-items-start ">
                                            <input <?php echo $status == 1 ? 'checked' : '' ?> value="booked-main"
                                                type="checkbox" class="form-check-input" id="booked-check"
                                                name="booked">
                                            <label style="line-height: 14px" for="booked-check"
                                                class="form-check-label">Booked<br><small class="f-12 p-0 m-0"
                                                    style="font-weight: normal">Number of
                                    ...
                                    <div class="col-12 mb-3 mt-3">
                                        <?php $status = findObjectByValue('canceled-main', $analytics)->status ?>
                                        <div class="d-flex align-items-start ">
                                            <input <?php echo $status == 1 ? 'checked' : '' ?> value="canceled-main"
                                                type="checkbox" class="form-check-input" id="canceled-check"
                                                name="canceled">
                                            <label style="line-height: 14px" for="canceled-check"
                                                class="form-check-label">Canceled<br><small class="f-12 p-0 m-0"
                                                    style="font-weight: normal">Number of
                                ...
                                <div class="row  bg-light p-3 mt-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <?php $status = findObjectByValue('most-orders-main', $analytics)->status ?>
                                        <div class="d-flex align-items-start ">
                                            <input <?php echo $status == 1 ? 'checked' : '' ?> value="most-orders-main"
                                                type="checkbox" class="form-check-input" id="most-orders"
                                                name="most-orders">
                                            <label style="line-height: 14px" for="most-orders"
                                                class="form-check-label">Most Orders<br><small class="f-12 p-0 m-0"
                                                    style="font-weight: normal">Customers with
                                    ...
                                    <div class="col-12 mt-3">
                                        <?php $status = findObjectByValue('no-orders-main', $analytics)->status ?>
                                        <div class="d-flex align-items-start ">
                                            <input <?php echo $status == 1 ? 'checked' : '' ?> value="no-orders-main"
                                                type="checkbox" class="form-check-input" id="no-orders"
                                                name="no-orders">
                                            <label style="line-height: 14px" for="no-orders" class="form-check-label">No
                                                Orders<br><small class="f-12 p-0 m-0"
                                                    style="font-weight: normal">Customers with
                                                    no
                                                    orders</small></label>
                                        </div>
                                ...
                                <div class="row bg-light mt-3 p-3">
                                    ...
                                    <div class="col-12">
                                        <?php $status = findObjectByValue('total-orders-main', $analytics)->status ?>
                                        <div class="d-flex align-items-start">
                                            <input <?php echo $status == 1 ? 'checked' : '' ?> value="total-orders-main"
                                                type="checkbox" class="form-check-input" id="companies-total-orders"
                                                name="companies-total-orders">
                                            <label style="line-height: 14px" for="companies-total-orders"
                                                class="form-check-label">Total Orders<br><small class="f-12 p-0 m-0"
                                                    style="font-weight: normal">Number of total
                                    ...
                                    <div class="col-12 mt-4">
                                        <?php $status = findObjectByValue('company-orders-main', $analytics)->status ?>
                                        <div class="d-flex align-items-start">
                                            <input <?php echo $status == 1 ? 'checked' : '' ?> value="company-orders-main"
                                                type="checkbox" class="form-check-input" id="companies-orders"
                                                name="companies-orders">
                                            <label style="line-height: 14px" for="companies-orders"
                                                class="form-check-label">Company Orders<br><small class="f-12 p-0 m-0"
                                                    style="font-weight: normal">Number of
                                                    orders created in companies</small></label>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12 d-flex flex-column justify-content-between align-items-between">
                            <div class="">
                                <div class="row bg-light p-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="order_id"
                                                name="customize_columns[]" id="order_id">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="vasc_id"
                                                name="customize_columns[]" id="vasc_id">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked
                                                value="security_number" name="customize_columns[]" id="security_number">
                                            <label style="line-height: 14px" for="security_number"
                                                class="form-check-label ">
                                                Security Number
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="candidate"
                                                name="customize_columns[]" id="can_name">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="company"
                                                name="customize_columns[]" id="cus_company">
                                            <label style="line-height: 14px" for="cus_company"
                                                class="form-check-label ">
                                                Company
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="customer"
                                                name="customize_columns[]" id="cus_name">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked
                                                value="invoice_recepient" name="customize_columns[]"
                                                id="invoice_recepient">
                                            <label style="line-height: 14px" for="invoice_recepient"
                                                class="form-check-label ">
                                                Invoice Recipient
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked
                                                value="invoice_reference" name="customize_columns[]"
                                                id="invoice_reference">
                                            <label style="line-height: 14px" for="invoice_reference"
                                                class="form-check-label ">
                                                Invoice Reference
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked
                                                value="invoice__comment" name="customize_columns[]"
                                                id="invoice__comment">
                                            <label style="line-height: 14px" for="invoice__comment"
                                                class="form-check-label ">
                                                Invoice Comment
                                            </label>
                                        </div>
                                                ...
                                                if (count($parts) >= 2) {
                                                    ...
                                                    if (isset($parts[6]) && !empty($parts[6]) && $parts[6] == 'new_field') {
                                                        ...
                                                        if ($index != 'note') {
                                                            ...
                                                            // if (($form->company)) {
                                                            //     $comp[] = trim($form->company);
                                                            // } else {
                                                            //     $comp[] = $form->company;
                                                            // }
                                                            // $comp = array_unique($comp);
                                                            // $str_comp = implode(',', $comp);
                                                            // if (!in_array($result, $processedStrings)) {
                                                            ?>
                                                            <div class="col-md-12">
                                                                <div class="d-flex align-items-start mt-2 mb-2">
                                                                    <input type="checkbox" class="form-check-input billing_detail" checked
                                                                        value="<?= strtolower(str_replace(' ', '_', $result)) ?>"
                                                                        name="customize_columns[]" data-id="<?= $index ?>"
                                                                        id="<?= strtolower(str_replace(' ', '_', $result)) ?>"
                                                                        data-company="<?= $form->company ?>">
                                                                    <label style="line-height: 14px"
                                                                        for="<?= strtolower(str_replace(' ', '_', $result)) ?>"
                                                                        class="form-check-label ">
                                                                        <?= $result; ?>
                                                                    </label>
                                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="cost_place"
                                                name="customize_columns[]" id="cost_place">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="status"
                                                name="customize_columns[]" id="status">
                                    ...
                                    <div style="display:none">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked
                                                value="recent_status" name="customize_columns[]" id="recent_status">
                                            <label style="line-height: 14px" for="recent_status"
                                                class="form-check-label ">
                                                Recent Status
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked
                                                value="interview_date" name="customize_columns[]" id="interview_date">
                                            <label style="line-height: 14px" for="interview_date"
                                                class="form-check-label ">
                                                Interview Date
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked
                                                value="delivery_date" name="customize_columns[]" id="delivery_date">
                                            <label style="line-height: 14px" for="delivery_date"
                                                class="form-check-label ">
                                                Delivery Date
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="invoice_sent"
                                                name="customize_columns[]" id="invoice_sent">
                                            <label style="line-height: 14px" for="invoice_sent"
                                                class="form-check-label ">
                                                Invoice Sent
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="staff"
                                                name="customize_columns[]" id="Staff">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="place"
                                                id="place" name="customize_columns[]">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="service_type"
                                                name="customize_columns[]" id="service_type">
                                            <label style="line-height: 14px" for="service_type"
                                                class="form-check-label ">
                                                Service Type
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="created_on"
                                                name="customize_columns[]" id="created_on">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked
                                                value="service__cost" name="customize_columns[]" id="service__cost">
                                            <label style="line-height: 14px" for="service__cost"
                                                class="form-check-label ">
                                                Service Cost
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="travel__cost"
                                                name="customize_columns[]" id="travel__cost">
                                            <label style="line-height: 14px" for="travel__cost"
                                                class="form-check-label ">
                                                Travel Cost
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input" checked value="total__cost"
                                                name="customize_columns[]" id="total__cost">
                                            <label style="line-height: 14px" for="total__cost"
                                                class="form-check-label ">
                                                Total Cost
                                            </label>
                                        </div>
...
<script>
    ...
    function change_title(obj) {
        ...
        } else if ($(obj).val() == 1 || $(obj).val() == 9) {
            $('.interview_label_from').html('Interview Date From');
            $('.interview_label_to').html('Interview Date To');
        } else {
            $('.interview_label_from').html('Interview/Delivery Date From');
            $('.interview_label_to').html('Interview/Delivery Date To');
        }
    }
    $(document).ready(function () {
        function removeDuplicateCheckboxes() {
            ...
            $('input[type="checkbox"].billing_detail').each(function () {
                var checkboxId = $(this).attr('id');
                checkboxId = $.trim(checkboxId).toLowerCase()
                var companyData = $(this).data('company');
                companyData = $.trim(companyData).toLowerCase()

                var uniqueKey = checkboxId + '_' + companyData;
        ...
        function hideDuplicateCheckboxes() {
            // Create an object to track unique checkboxes based on id and data-company
            var seen = {};
            ...
            $('input[type="checkbox"].billing_detail').each(function () {
                ...
                // Generate a unique key by combining the id and data-company
                var uniqueKey = checkboxId;

                // If this key has been seen before, hide the checkbox
                if (seen[uniqueKey]) {
                    $(this).closest('.col-md-12').hide(); // Hide the checkbox and its container
                } else {
        ...
        // Call the function after the checkboxes have been generated
        hideDuplicateCheckboxes();
