...
$query = 'SELECT staff.*, COUNT(c.staff_id) AS total_orders FROM staff';
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu p-2 ps-3 table-menu-btn-list" aria-labelledby="dropdownMenuButton1">
                                                            ...
                                                            <li class="mb-1"><a href="staff-permission.php?id=<?php echo $st->id ?>" class="no-decoration f-14 w-600 text-black "><i class="bi bi-shield-lock text-black f-14 me-2"></i>
                                                                    Permissions</a>
                                                            </li>
