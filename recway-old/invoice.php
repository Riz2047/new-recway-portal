    ...
    <div class="container mt-3">
        ...
        <div class="col-lg-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <a style="cursor: pointer" onclick="window.history.back();" class="go-back"><i class="bi bi-arrow-left-short me-1"></i>Go Back</a>
                </div>
                <!--                    <div class="dropdown action-dropdown mb-4">-->
                <!--                        <a class=" dropdown-btns" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">-->
                <!--                            Action <i class="bi bi-chevron-down f-12 ms-1 text-black"></i>-->
                <!--                        </a>-->
                <!--                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">-->
                <!--                            <li><a class="dropdown-item" href="update-candidate.php?id=--><?php //echo $candidate->id 
                                                                                                                ?><!--"><i-->
                <!--                                            class="bi bi-pen text-black f-14 me-2"></i>Edit</a></li>-->
                <!--                            <li><a class="dropdown-item" --><?php //echo $candidate->status == 7 ? 'style="pointer-events: none;"' : '' 
                                                                                ?><!-- href="cancel.php?--><?php //echo 'id=' . $candidate->id 
                                                                                                            ?><!--" --><?php //echo $candidate->status == 7 ? 'style="color:#bebebe;"' : '' 
                                                                                                                        ?><!--><i-->
                <!--                                            class="bi bi-x-circle text-black f-14 me-2"></i>Cancel</a></li>-->
                <!--                        </ul>-->
                <!--                    </div>-->
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-lg-3 mb-3">
                ...
                <div class="actions row">
                    <div class="col-lg-6">
                        <button onclick="location.href = 'update-candidate.php?id=<?php echo $candidate->id ?>'" class="form-btn border-0 w-100 mt-2">Edit</button>
                    </div>
                    <div class="col-lg-6">
                        <button onclick="location.href = 'cancel.php?<?php echo 'id=' . $candidate->id ?>'" class="form-btn border-0 w-100 mt-2">Cancel</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 px-lg-0 mb-3 ">
                <div class="grey-box ">
                    <div class="tab">
                        ...
                        <button class="tablinks f-12 w-700 " onclick="openCity(event, 'billing')">Billing Details</button>
                        <button class="tablinks f-12 w-700 " onclick="openCity(event, 'notes')">Additional Note</button>
                        <button class="tablinks f-12 w-700 " onclick="openCity(event, 'documents')">Documents</button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 p-0">
                                    ...
                                    <?php if (!empty($interview->country)) : ?>
                                        <div class="mt-3">
                                            <p class="f-12 w-600 text-grey mb-0 pb-0">Country</p>
                                            <p class="f-14 w-700 text-black"><?php echo !empty($candidate->country) ? $candidate->country : "Null" ?></p>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if (getStatusServiceCat($candidate->status)->service_cat_id == BACKGROUND_ID) : ?>
                                        <div class="mt-3">
                                            <p class="f-12 w-600 text-grey mb-0 pb-0">Report Status</p>
                                            <p class="f-14 w-700 " style="color: <?php echo $statusColors[$candidate->report_status] ?>"><?php echo $reportStatus[$candidate->report_status] ?></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 p-0">
                                    <div class="mt-3">
                                        ...
                                        ?>
                                            <p class="f-12 w-600 text-grey mb-0 pb-0 text-lg-start text-center">Documents</p>
                                        ...
                                        ?>
                                            <p class="f-12 w-600 text-grey mb-0 pb-0 text-lg-start text-center">Background Check Report</p>
                                        ...
                                        ?>
                                            <p class="f-12 w-600 text-grey mb-0 pb-0 text-lg-start text-center">Interview Template</p>
                                            <p style="overflow: hidden;white-space: nowrap; text-overflow: ellipsis" class="mb-0 w-100 f-18 p-0 pt-1"><a target="_blank" href="../uploads/<?php echo $candidate->interview_template ?>" style="cursor: pointer" class="text-success open-doc"><i class="bi bi-filetype-pdf me-2"></i><small><?php echo $candidate->interview_template ?></small></a></p>
                                        <?php endif; ?>
