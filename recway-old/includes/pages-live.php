...
if (isset($_POST['action']) && $_POST['action'] == 'get_candidates_data') {
    ...
    $columns = ['c.id', 'c.id', 'c.id', 'c.id', 'c.order_id', 'p.name', 'c.vasc_id', 'c.name', 'c.security', 'cu.name', 'cu.company', 's.name', 'c.reported_to_sm', 'st.status', 'c.invoice_sent', 'c.booked', 'c.economy', 'c.criminal_record', 'c.social', 'c.invoice_date', 'c.background_check_date', 'c.created', 'c.delivery_date', 'c.delivery_date', 'i.title'];
