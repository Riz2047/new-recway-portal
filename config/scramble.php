...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Recway API - A comprehensive Laravel CMS API with User Management, Content Management, Role & Permission system, and more.
            <br>
    ...
    'ui' => [
         ...
         */
        'title' => 'Recway API Documentation',
